...
public class Comercial extends Persona {
    ...
    public Comercial(int idPersona, String nombre, String email, String telefono, LocalDateTime fechaRegistro, int idComercial, String codigoComercial, String apellidos, String zonaGeografica, LocalDate fechaAlta) {
